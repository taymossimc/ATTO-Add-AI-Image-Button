...
/**
 * Initialization function for the template YUI module
 * 
 * @method init
 * @param {Object} config Configuration parameters
 * @static
 */
Y.M.atto_template.Button.init = function(config) {
    if (console && console.log) {
        console.log('DEBUG: M.atto_template.Button.init called with config:', config);
    }
    
    // This is a static initialization function that can be called manually
    return true;
}; 