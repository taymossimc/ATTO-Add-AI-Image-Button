YUI.add('moodle-atto_aiimage-button', function (Y, NAME) {
...
Y.namespace('M.atto_aiimage').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    _generateImage: function(e) {
        ...
        var params = {
            ...
            prompt: prompt,
            apikey: '', // API key will be obtained from server-side settings
            baseurl: this._apiSettings.baseurl,
            model: this._apiSettings.model,
            timeout: this._apiSettings.timeout,
...
}, '@VERSION@', {"requires": ["moodle-editor_atto-plugin", "moodle-core-notification-dialogue"]}); 